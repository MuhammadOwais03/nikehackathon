...
export default function ContactUs() {
    return (
        <>
            ...
            <div className="container mx-auto px-4 py-12 text-gray-700 flex  items-center flex-col px-[12rem]">
                <h1 className="text-3xl font-bold mb-8 text-center">GET HELP</h1>
                <div className="relative h-[56px] w-[457.33px] flex items-center px-6 bg-white-100 rounded-[10px] border border-black mb-8">
                    {/* <FontAwesomeIcon icon={faMagnifyingGlass} className="text-gray-500 w-4 h-4 absolute left-[10px]" /> */}
                   
                    
                    <svg width="25" height="18" viewBox="0 0 25 18" fill="none" xmlns="http://www.w3.org/2000/svg " className="text-gray-500 absolute right-[8px]">
