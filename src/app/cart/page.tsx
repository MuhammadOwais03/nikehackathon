    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center px-4 md:px-16 py-8">
                <div className="w-full md:w-4/5 flex flex-col-reverse md:flex-row justify-between bg-white p-6 rounded-lg shadow-lg">
                    {/* Cart Items Section */}
                    <div className="w-full md:w-3/5">
                        ...
                        <div className="flex flex-wrap items-start border-b border-gray-300 py-4">
                            {/* Product Image */}
                            <div className="w-[150px] h-[150px] flex-shrink-0 mx-auto md:mx-0">
                                <Image
                                    src={L4.src}
                                    alt="Product Image"
                                    width={150}
                            ...
                            {/* Product Details */}
                            <div className="flex-grow px-4 mt-4 md:mt-0 text-center md:text-left">
                                ...
                                <div className="flex justify-center md:justify-start text-[15px] text-gray-500">
                                ...
                                <div className="flex justify-center md:justify-start space-x-4 mt-2">
                                    <button className="text-gray-500 hover:text-black">
                                        <FontAwesomeIcon icon={faHeart} className="text-black hover:text-gray-500 text-[22px]" />
                                    </button>
                                    <button className="text-gray-500 hover:text-black">
                    ...
                    <div className="w-full md:w-2/5 mt-8 md:mt-0 md:pl-8">
                        <h3 className="text-[15px] font-semibold mb-4 text-center md:text-left">Summary</h3>
                        ...
                        <a className="w-full bg-black text-white py-3 px-4 rounded-full text-[15px] block text-center" href="/checkout">Member Checkout</a>
                    </div>
                </div>
            </div>
            <Footer />
