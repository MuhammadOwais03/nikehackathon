...
import './styles/womenSlider.css';

export default function womenSlider() {
    console.log(womenData)
    const slideLeft = () => {
        let slider = document.getElementById('womenSliderContent');
        if (slider) {
    ...
    return (
        <div id="womenSlider" className="w-full overflow-hidden">
